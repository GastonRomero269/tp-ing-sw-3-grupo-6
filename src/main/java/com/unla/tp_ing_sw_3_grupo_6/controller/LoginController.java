...
public class LoginController {
	...
	public String register(@RequestParam String nombre, @RequestParam String apellido, @RequestParam String email, @RequestParam String tipoDni, @RequestParam int dni, @RequestParam String genero, @RequestParam String password, HttpSession session, Model model) {
		Usuario usuario = usuarioService.findByEmail(email);
		...
		Usuario nuevoUsuario = new Usuario(nombre, apellido, email, password, LocalDateTime.now(), "USUARIO", tipoDni, dni, genero, null);
